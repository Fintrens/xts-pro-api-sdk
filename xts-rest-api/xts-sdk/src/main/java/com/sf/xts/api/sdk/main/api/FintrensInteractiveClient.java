...
public class FintrensInteractiveClient extends FintrensConfigurationProvider {
  ...
  public FintrensInteractiveClient(XTSAPIInteractiveEvents xtsapiInteractiveEvents)
      throws IOException {
    loadConfiguration();
  ...
  public Position getPosition(String posType) throws APIException {
    String data =
        requestHandler.processGettHttpRequest(
            new HttpGet(interactiveURL + positions + "?dayOrNet=" + posType),
            "POSITION",
            authToken);
  ...
  public PlaceOrderResponse PlaceOrder(PlaceOrderRequest placeOrderRequest) {
    ...
    String data =
        requestHandler.processPostHttpRequest(
            new HttpPost(interactiveURL + orderBook), placeOrderJson, "PLACEORDER", authToken);
